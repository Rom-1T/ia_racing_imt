...
-----------
import dk
cfg = dk.load_config(config_path='~/mycar/ae_config.py')
...
#it's very IMPORTANT that this value is matched from the training PC ae_config.py and the robot.py
...
DONKEY_GYM = True
DONKEY_SIM_PATH = "C:\\Users\\pierr\\Documents\\PROJET3A\\DonkeySimWin\\donkey_sim.exe" #"/home/tkramer/projects/sdsandbox/sdsim/build/DonkeySimLinux/donkey_sim.x86_64" when racing on virtual-race-league use "remote", or user "remote" when you want to start the sim manually first.
