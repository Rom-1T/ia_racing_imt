...
class LocalWebController(tornado.web.Application):
    ...
    def run_threaded(self, img_arr=None, img_prepro = None, num_records=0, mode=None, recording=None, thr = None, steer = None, lapCounter = 0, end = False, start = True):
        """
        ...
        if thr is not None:
            changes["throttle"] = str(thr);
        
        if steer is not None:
            changes["angle"] = str(steer);
        ...
        return self.angle, self.throttle, self.mode, self.recording, buttons, stopCount, forcedStart

    def run(self, img_arr=None, img_prepro = None, num_records=0, mode=None, recording=None, thr = None, steer = None, lapCounter = 0, end = False):
        return self.run_threaded(img_arr, img_prepro, num_records, mode, recording, thr, steer, lapCounter, end)
...
class WebSocketDriveAPI(tornado.websocket.WebSocketHandler):
    ...
    def on_message(self, message):
        ...
        # self.write_message(json.dumps({'angle': self.application.angle, 'throttle': self.application.throttle}))
