...
START_LOWER_GREEN = [71, 74, 100]
START_UPPER_GREEN = [91, 200, 255]
START_GREEN_AREA_MIN = 2200


STOP_DETECTION = True
#STOP_DETECTION_MODEL_PATH = os.getcwd() + "/models/sigmoid_sigma_crop40.pth"
#THROTTLE_STOP_DETECTION = 0.5
#STOP_DETECTION_DEVICE = "cpu"
#STOP_LOWER_YELLOW = [24, 70, 100]
STOP_LOWER_YELLOW = [27, 112, 109] #### SEMBLE BON
STOP_UPPER_YELLOW = [37, 159, 242] #### SEMBLE BON
STOP_YELLOW_AREA_MIN = 600
LAP_COUNTER_MAX = 20 # Si on commence avant la ligne, rajouter + 1
STOP_DETECTION_PREVIOUS_IMG_BASE = 2
# STOP_DETECTION_PRINT = True

SIM_SPEED_VEHICULE = True # Ne pas changer pour avoir la vitesse réelle sur l'interface web
...
# PREPROCESSED_METHODS = ['bnw', 'gaussian', 'threshold']
PREPRO_LINES_THROTTLE1 = 150
PREPRO_LINES_THROTTLE2 = 200
PREPRO_LINES_APERTURE_SIZE = 3

SPEED_MULTIPLIER = 1.5

SUPERVISED_DRIVER = False
SUPERVISED_DEVICE = "cpu"
SUPERVISED_STATE_DICT_PATH = os.getcwd() + "/models/500.torch"
SUPERVISED_THROTTLE_MAX = 0.3
...
BATCH_SIZE = 12                #how many records to use when doing one pass of gradient decent. Use a smaller number if your gpu is running out of memory.
...
#DONKEY_GYM = True
#DONKEY_SIM_PATH = "/Users/IMT_Atlantique/project_ia/DonkeySimMac/donkey_sim.app/Contents/MacOS/donkey_sim" #"/home/tkramer/projects/sdsandbox/sdsim/build/DonkeySimLinux/donkey_sim.x86_64" when racing on virtual-race-league use "remote", or user "remote" when you want to start the sim manually first.
