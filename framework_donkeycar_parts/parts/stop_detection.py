...
class StopDetection():
    ...
    def __init__(self, cfg):
        ...
        self.throttle = cfg.THROTTLE_STOP_DETECTION
    ...
    def run(self, image_arr, throttle, stopCount):
        if not(stopCount):
            ...
            with torch.no_grad():
                ...
                # print(outputs)
                output_label = 1 if self.throttle < float(outputs[0]) else 0
